...
//-- Класс Vehicle
	...
	public function AI_fast_loop():void {
		...
		//-- Команды есть? и
		//-- состояние движения НАЧАЛО ДВИЖЕНИЯ ПО ПРОГРАММЕ или ДВИЖЕНИЕ ПО ПРОГРАММЕ?
		if(commands != null 
	...
	public function move():void { 
		//-- Движение. Отрабатывает установленные руль и power.
		//-- Не работает если игра остановлена или прошло меньше 50 мс с прошлого вызова.
		//-- Отрисовывается хвост.
				if (!main.isStarted()) {
					return;
				}
				//before_move();
	...
	//-- Выход
		...
		//-- 
		//--       setMaxVelocityHum(),getMaxVelocityHum(),
		//-- moveOnTarget(),selectTarget(),drawShip(),
		//-- draw_ship(),draw_ship_selected(),getTimeLiveMs()
		//--       
		...
		//-- 
		//--       setForces(),getForces(),setPower(),getPower(),
		//-- setRudder(),start_move(),setName(),
		//-- getName(),setTailVisible(),setVisible(),
		//-- new_disp_pos_tail(),new_dysp_pos_way_points()
		//--       
		...
		//-- 
		//--       getPhisVelocity() - phisical velosity in knots
		//-- getVelocity()
		//-- set_velocity()
		//--       
			/**
